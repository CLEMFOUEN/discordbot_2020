...
module.exports.run = (client, message, args) => {
  const embed = new MessageEmbed()
    ...
    .addFields(
      ...
      { name: 'Source', value: `[GitHub](https://github.com/getcodingknowledge/discordbot_2020)`, inline: true},
      { name: 'Support', value: `[Server invite](https://discord.gg/azekazel)`, inline: true},
    );
